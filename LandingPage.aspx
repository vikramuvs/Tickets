...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    <br />
    <div class="row container col-md-12" style="font: large Montserrat;">
        <br />
        <h4>
            <strong>Here are your applications that you can access: </strong>
        </h4>
    </div>
   <%-- <div style="border: 1px solid gray; margin: 100px;">--%>
        <%--<div class="row">
            <div class="col-sm-4">
                <a href="http://www.ubh.com" class="tile purple">
                    <h3 class="title">
                        Purple Tile</h3>
                    <p>
                        Short, sweet data point goes here.</p>
                </a>
            </div>
        --%>
